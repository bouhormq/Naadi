...
console.log('🔍 Testing Partner App Bookings API Endpoints...');
...
async function testStudioBookingsEndpoint() {
  ...
  try {
    ...
    // Test case 5: Studio not owned by partner
  ...
  async function handleGetBookingById(request) {
    try {
      ...
      try {
        ...
        // Get studio to verify it belongs to the partner
