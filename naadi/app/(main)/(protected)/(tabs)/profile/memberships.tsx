      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <View style={styles.iconContainer}>
            ...
            <MaterialCommunityIcons name="autorenew" size={50} color="black" style={styles.icon} />
          </View>
          <Text style={styles.noVouchersText}>You have no active memberships</Text>
          <Text style={styles.subtext}>Find venues to get a membership or book a service.</Text>
