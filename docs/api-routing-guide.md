...
1. **Shared Logic Layer** (`packages/api`): Contains core partner logic shared between apps
...
This layer contains core partner logic that can be used by both apps. It's structured as follows:
...
These modules export functions that implement the core partner logic, e.g.:
...
5. The shared logic performs the partner operations
