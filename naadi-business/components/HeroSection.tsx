...
const businessCardData = [
  ...
  },
  {
    ...
    text: 'Add details of your business such as photos and descriptions of your services and amenities.',
  },
  {
    id: 'b3',
...
const memberCardData = [
  {
    id: 'm1',
    image: require('../assets/book-classes-image.webp'),
...
export default function HeroSection() {
  ...
  const currentCardData = activeTab === 'businesses' ? businessCardData : memberCardData;
