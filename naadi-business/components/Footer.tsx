    ...
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.linkItem}>
          <Text onPress={() => router.push('/')} style={styles.linkText}>About us</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.linkItem}>
          <Text onPress={() => router.push('/how-it-works')} style={styles.linkText}>How it works</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.linkItem}>
          <Text onPress={() => router.push('/contact')} style={styles.linkText}>Contact Us</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.linkItem}>
          <Text onPress={() => router.push('/faq')} style={styles.linkText}>FAQ</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.linkItem}>
          <Text onPress={() => router.push('/signup')} style={styles.linkText}>Become a Partner</Text>
        </TouchableOpacity>
      </View>
