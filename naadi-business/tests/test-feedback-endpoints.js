...
console.log('🔍 Testing Business App Feedback API Endpoints...');
...
async function testStudioFeedbackEndpoint() {
  ...
  try {
    ...
    // Test case 1: Get feedback with valid business token and studioId
    ...
    // Test case 3: User account trying to access business endpoint
    // Add a non-business user
    ...
    // Test case 6: Studio not owned by the business
    // Create a studio not owned by the business
...
async function testClassFeedbackEndpoint() {
  ...
  try {
    ...
    // Test case 1: Get feedback with valid business token and classId
    const request1 = new MockExpoRequest({
