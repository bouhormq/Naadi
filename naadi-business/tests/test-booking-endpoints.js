...
console.log('🔍 Testing Business App Booking API Endpoints...');
...
async function testGetAllBookingsEndpoint() {
  ...
  try {
    // Test case 1: Get all bookings for business
    ...
    console.log('✅ Successfully retrieved all bookings for business');
        ...
        try {
          ...
          try {
            ...
            if (booking.businessId !== business.id) {
              return {
                status: 403,
                body: { error: 'Access denied. Booking does not belong to this business.' }
              };
            }
